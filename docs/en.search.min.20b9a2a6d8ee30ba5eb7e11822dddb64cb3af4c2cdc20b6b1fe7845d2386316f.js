...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/tech-writing/flexsearch.min.js');loadScript('/tech-writing/en.search-data.min.846df9fe4275bbb0f41be66fbe0ed5d1fa251c31afd2e08a65ec356468d3e285.js',function(){input.required=false;search();});}
