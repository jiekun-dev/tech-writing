...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/ultimate-go-notebook/flexsearch.min.js');loadScript('/ultimate-go-notebook/en.search-data.min.731cf277417caad41ebe2c369d3cfded0029be8463ee1836aae2aad5e3165209.js',function(){input.required=false;search();});}
